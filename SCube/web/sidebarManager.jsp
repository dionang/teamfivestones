<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" id="logo" style="border: 0;">
            <a href="" class="site_title"><img src="assets/images/logo.jpg" style="height:57px;width:100px;"></a>
        </div>
        <div class="navbar nav_title" id="logo2" style="border: 0;display:none;">
            <a href="" class="site_title"><img src="assets/images/logo1.jpg" style="height:57px;width:50px;"></a>
        </div>
